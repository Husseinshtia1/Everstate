...
def register(app: typer.Typer, service_factory) -> None:
    ...
    def autobuild(
        ...
        """Execute a multi-stage autonomous build plan with council review and deterministic gates."""
        ...
        if json_output:
            ...
            for stage in run.stages:
                ...
                console.print(f"{mark} {stage.stage_id} {stage.title} attempts={len(stage.attempts)} council={stage.council_backend}/{stage.council_participants}")
